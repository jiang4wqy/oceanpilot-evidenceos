...
> 生成时间：2026-09-08T03:36:19Z ｜ 案例总数：62（SOURCE_EXPLICIT 34 / RULE_DERIVED 13 / SYNTHETIC_DEMO 15）
...
- **所需证据**：
  - 规则界定（RULE，必填，默认来源：SYSTEM_OF_RECORD）——为何需要：明确侵权(torts)不在 4853/4854 受理范围；规则依据：SRC-02 P152/P460/P950/P1157；本案可得性：不适用；缺失后果：误拒付会导致收单方用 2713/Invalid Chargeback 抗辩
...
- **所需证据**：
  - 18 个月折算规则（CALCULATION_RULE，必填，默认来源：SYSTEM_OF_RECORD）——为何需要：确定服务中断类拒付金额；规则依据：SRC-02 P178/P968/P1511；本案可得性：是（原文自带算式）；缺失后果：金额算错会被 2713/2702 抗辩
...
- **所需证据**：
  - 持卡人签署的免责弃权书（WAIVER，必填，默认来源：OCR_THEN_REVIEW）——为何需要：证明持卡人同意以发货证明为履约标准；规则依据：SRC-02 P178/P968/P1511；本案可得性：是；缺失后果：无弃权书则无法免除运输责任
  - 发货凭证（SHIPPING，必填，默认来源：MERCHANT_UPLOAD）——为何需要：证明商品已实际发出；规则依据：同上；本案可得性：是；缺失后果：无法构成抗辩
...
- **所需证据**：
  - 签收证明（DELIVERY，可选，默认来源：CONDITIONAL）——为何需要：证明包裹由持卡人签收；规则依据：SRC-02 P183/P972；本案可得性：视案件而定；缺失后果：降低抗辩可信度
  - 称重/监控/打包记录（LOGISTICS，可选，默认来源：MERCHANT_UPLOAD）——为何需要：证明发出时内容物正确；规则依据：SRC-02 P178/P967；本案可得性：视案件而定；缺失后果：难以反驳“空箱”主张
...
- **所需证据**：
  - 商户对篡改的合理具体说明（MERCHANT_NARRATIVE，必填，默认来源：MERCHANT_UPLOAD）——为何需要：说明单据如何被部分篡改或伪造；规则依据：SRC-02 P162/P957；本案可得性：视案件而定；缺失后果：抗辩不成立
...
- **所需证据**：
  - 退货开箱检验记录（RETURN_INSPECTION，必填，默认来源：MERCHANT_UPLOAD）——为何需要：证明退回物品与原商品不符；规则依据：SRC-02 P163/P958/P1042；本案可得性：视案件而定；缺失后果：无法证明退货欺诈
...
- **所需证据**：
  - 授权与撤销报文记录（AUTHORIZATION_LOG，必填，默认来源：MERCHANT_UPLOAD）——为何需要：证明批准与撤销金额符合规则；规则依据：SRC-02 P64-65/P934；本案可得性：视案件而定；缺失后果：无法抗辩
...
- **所需证据**：
  - 交易记录（MCC/金额/授权）（TX_RECORD，必填，默认来源：SYSTEM_OF_RECORD）——为何需要：判断是否落在门槛内；规则依据：SRC-02 P61/P885-886；本案可得性：是；缺失后果：无法自动判定
...
- **所需证据**：
  - 终端标识与交易要素（TERMINAL_DATA，必填，默认来源：SYSTEM_OF_RECORD）——为何需要：证明 CAT 级别、MCC、金额、标识正确；规则依据：SRC-02 P115/P921-922；本案可得性：视案件而定；缺失后果：无法抗辩
...
- **所需证据**：
  - 合同/扣款协议（AGREEMENT，必填，默认来源：MERCHANT_UPLOAD）——为何需要：判断有无终止日；规则依据：SRC-02 P312/P330；本案可得性：视案件而定；缺失后果：无法正确定性
...
- **所需证据**：
  - 原交易合同/租赁协议（ORIGINAL_AGREEMENT，必填，默认来源：MERCHANT_UPLOAD）——为何需要：证明持卡人参与原交易；规则依据：SRC-02 P350/P353/P501；本案可得性：视案件而定；缺失后果：无法证明 addendum 关系
  - 违章记录（30 日内提交）（VIOLATION_RECORD，必填，默认来源：MERCHANT_UPLOAD）——为何需要：证明罚单发生于租期内；规则依据：SRC-02 P353/P1093；本案可得性：视案件而定；缺失后果：抗辩失败
...
- **所需证据**：
  - 预订前政策告知证明（CANCELLATION_NOTICE，必填，默认来源：OCR_THEN_REVIEW）——为何需要：证明已告知 18:00 前取消的收费政策；规则依据：SRC-02 P371/P1106；本案可得性：视案件而定；缺失后果：无法收取 no-show 费
  - 电话账单（取消时限内联系证明）（PHONE_BILL，条件性，默认来源：MERCHANT_UPLOAD）——为何需要：持卡人主张已取消时，预仲裁阶段需证明在时限内联系过商户；规则依据：SRC-02 P381/P1112；本案可得性：视案件而定；缺失后果：取消主张不成立
...
- **所需证据**：
  - 新原因所需支持文档（NEW_REASON_DOCS，必填，默认来源：MERCHANT_UPLOAD）——为何需要：应对变更后的争议原因；规则依据：SRC-02 P477-478/P1171；本案可得性：视案件而定；缺失后果：新原因下败诉
...
- **所需证据**：
  - 显示金额与币种的收据（RECEIPT，必填，默认来源：OCR_THEN_REVIEW）——为何需要：证明扣款币种与报价关系；规则依据：SRC-02 P741-742/P1371；本案可得性：视案件而定；缺失后果：无法判定差额
...
- **所需证据**：
  - ATM 日志与币种选择记录（ATM_JOURNAL，必填，默认来源：MERCHANT_UPLOAD）——为何需要：证明持卡人的币种选择与实际执行；规则依据：SRC-02 P872-873；本案可得性：视案件而定；缺失后果：无法判定
...
- **所需证据**：
  - 退款记录（CRED MMDDYY ARD）（REFUND_RECORD，必填，默认来源：SYSTEM_OF_RECORD）——为何需要：在二次呈请中记载退款；规则依据：SRC-02 P38/P510/P935；本案可得性：视案件而定；缺失后果：Mastercard 可能判发卡行承担退款额、收单行承担罚费
...
- **所需证据**：
  - 第三方支付凭证与卡扣款说明（PAYMENT_PROOF，必填，默认来源：MERCHANT_UPLOAD）——为何需要：证明两笔支付对应关系；规则依据：SRC-02 P690/P1327-1328；本案可得性：视案件而定；缺失后果：抗辩失败
...
- **所需证据**：
  - 持卡人签字的逐项价目表（PRICE_LIST，必填，默认来源：OCR_THEN_REVIEW）——为何需要：证明金额区间经持卡人同意；规则依据：SRC-02 P770/P1395；本案可得性：视案件而定；缺失后果：无法证明金额合理
  - 按价目表计算的收据（RECEIPT，必填，默认来源：OCR_THEN_REVIEW）——为何需要：证明实际收费符合价目表；规则依据：同上；本案可得性：视案件而定；缺失后果：抗辩不完整
...
- **所需证据**：
  - 原交易时间戳收据/授权日志（TIMESTAMP，必填，默认来源：OCR_THEN_REVIEW）——为何需要：证明 15 分钟窗口；规则依据：SRC-02 P1495-1497；本案可得性：视案件而定；缺失后果：无法立案
  - 持卡人函件或 Form 0412（CARDHOLDER_STATEMENT，必填，默认来源：MERCHANT_UPLOAD）——为何需要：证明否认后续交易；规则依据：同上；本案可得性：视案件而定；缺失后果：无法立案
...
- **所需证据**：
  - 结账页政策披露截图（DISCLOSURE，必填，默认来源：OCR_THEN_REVIEW）——为何需要：证明取消政策在结账前有效披露；规则依据：SRC-01 P17-18；本案可得性：视案件而定；缺失后果：13.7 类争议难以抗辩
...
- **所需证据**：
  - 发票/合同（INVOICE，必填，默认来源：OCR_THEN_REVIEW）——为何需要：逐点反驳质量主张；规则依据：SRC-01 P43-44；本案可得性：视案件而定；缺失后果：抗辩乏力
  - 中立第三方意见（THIRD_PARTY_OPINION，可选，默认来源：MERCHANT_UPLOAD）——为何需要：强化质量合格的证明；规则依据：SRC-01 P44；本案可得性：视案件而定；缺失后果：主观争议难以反驳
...
- **所需证据**：
  - 认证结果（ECI 值）（AUTH_RESULT，必填，默认来源：SYSTEM_OF_RECORD）——为何需要：决定欺诈争议保护；规则依据：SRC-01 P14；本案可得性：是；缺失后果：无法判定保护状态
...
- **所需证据**：
  - 取消时间证明（CANCELLATION_TIME，必填，默认来源：CONDITIONAL）——为何需要：判断是否在 14 天内；规则依据：SRC-01 P17/P49-50；本案可得性：视案件而定；缺失后果：无法判定
...
- **所需证据**：
  - 违规事实证据（VIOLATION_PROOF，必填，默认来源：MERCHANT_UPLOAD）——为何需要：支撑合规案；规则依据：SRC-01 P20；本案可得性：视案件而定；缺失后果：合规案不成立
...
- **所需证据**：
  - 3DS/Device ID/IP/账号/邮箱/电话/账单地址/收货地址（IDENTITY，必填，默认来源：MERCHANT_UPLOAD）——为何需要：证明交易与持卡人关联；规则依据：SRC-03 §3；本案可得性：视案件而定；缺失后果：无法进入 CE3.0
  - 历史未争议交易（HISTORY，必填，默认来源：SYSTEM_OF_RECORD）——为何需要：CE3.0 历史交易匹配；规则依据：SRC-03 §3；SRC-01 P26；本案可得性：视案件而定；缺失后果：CE3.0 不成立
...
- **所需证据**：
  - 物流轨迹（TRACKING，必填，默认来源：CONDITIONAL）——为何需要：证明运输过程；规则依据：SRC-03 §5；本案可得性：视案件而定；缺失后果：无法证明发货
  - 签收证明（含收件人）（POD，必填，默认来源：OCR_THEN_REVIEW）——为何需要：证明交付给对应消费者；规则依据：SRC-03 §5；SRC-01 P40-41；本案可得性：视案件而定；缺失后果：证据链断裂
...
- **所需证据**：
  - 取消时间戳与确认（CANCELLATION，必填，默认来源：MERCHANT_UPLOAD）——为何需要：判断扣款时授权是否有效；规则依据：SRC-03 §6；本案可得性：视案件而定；缺失后果：无法判定
  - 循环扣款协议/MIT 标识（RECURRING_AUTH，必填，默认来源：MERCHANT_UPLOAD）——为何需要：证明扣款授权仍有效；规则依据：SRC-03 §6；本案可得性：视案件而定；缺失后果：抗辩无据
...
- **所需证据**：
  - 商品页/SKU/描述（PRODUCT_DESC，必填，默认来源：MERCHANT_UPLOAD）——为何需要：对比实际交付与描述；规则依据：SRC-03 §7；本案可得性：视案件而定；缺失后果：无法证明一致性
  - 发货/收货记录（DELIVERY_RECORD，必填，默认来源：OCR_THEN_REVIEW）——为何需要：证明实际发出的商品；规则依据：SRC-03 §7；本案可得性：视案件而定；缺失后果：抗辩无据
  - 检验报告（INSPECTION，可选，默认来源：MERCHANT_UPLOAD）——为何需要：证明商品状态；规则依据：SRC-03 §7；本案可得性：视案件而定；缺失后果：主观争议难反驳
...
- **所需证据**：
  - 退款交易（ARN/日期/金额/卡号/结算状态）（REFUND_TX，必填，默认来源：SYSTEM_OF_RECORD）——为何需要：证明退款已发起并结算；规则依据：SRC-03 §8；本案可得性：视案件而定；缺失后果：无法证明退款
...
- **所需证据**：
  - 订单/发票/服务对应关系（ORDER_MATCH，必填，默认来源：CONDITIONAL）——为何需要：证明两笔是独立交易或重复；规则依据：SRC-03 §9；本案可得性：视案件而定；缺失后果：无法判定重复
...
- **所需证据**：
  - 登录/访问/消费记录（USAGE_LOG，必填，默认来源：CONDITIONAL）——为何需要：证明服务已被使用；规则依据：SRC-03 §12；本案可得性：是（Login Count 17）；缺失后果：无法反驳不可访问
...
- **所需证据**：
  - 退货政策及披露（RETURN_POLICY，必填，默认来源：MERCHANT_UPLOAD）——为何需要：证明政策并判断是否遵守；规则依据：SRC-03 §15；本案可得性：视案件而定；缺失后果：无政策则难抗辩
  - 商品未实际退回的证据（RETURN_PROOF，必填，默认来源：MERCHANT_UPLOAD）——为何需要：反驳已退货主张；规则依据：SRC-03 §15；本案可得性：视案件而定；缺失后果：无法反驳
...
- **所需证据**：
  - 取消政策及披露（CANCELLATION_POLICY，必填，默认来源：MERCHANT_UPLOAD）——为何需要：证明截止时间已告知；规则依据：SRC-03 §16；本案可得性：视案件而定；缺失后果：无法收取消违约金
  - 取消时间戳（CANCELLATION_TIME，必填，默认来源：CONDITIONAL）——为何需要：证明取消晚于截止；规则依据：SRC-03 §16；本案可得性：视案件而定；缺失后果：抗辩无据
...
- **所需证据**：
  - 清晰账单描述与交易详情（DESCRIPTOR，必填，默认来源：MERCHANT_UPLOAD）——为何需要：让持卡人认出交易；规则依据：SRC-03 §20；本案可得性：视案件而定；缺失后果：争议风险升高
...
- **所需证据**：
  - 3DS/认证记录（AUTH，可选，默认来源：SYSTEM_OF_RECORD）——为何需要：认证成功可获保护；规则依据：SRC-01 P14/P26；本案可得性：视案件而定；缺失后果：转向 CE 证据
  - 2 笔同设备/同IP历史未争议交易（HISTORY，必填，默认来源：SYSTEM_OF_RECORD）——为何需要：CE 抗辩核心；规则依据：SRC-01 P26；本案可得性：视案件而定；缺失后果：CE 不成立
...
- **所需证据**：
  - 物流轨迹/航班起飞证明（TRACKING，必填，默认来源：CONDITIONAL）——为何需要：证明运输；规则依据：SRC-01 P40-41；本案可得性：视案件而定；缺失后果：无法证明发货
  - 签收证明/自提记录/服务使用日志（POD，必填，默认来源：OCR_THEN_REVIEW）——为何需要：证明交付给对应消费者；规则依据：SRC-01 P40-41；本案可得性：视案件而定；缺失后果：证据链断裂
- **处理流程**：first_see：案件进入后按原因码匹配规则 → auto：规则引擎装载对应条件与证据清单 → ops：按清单收集证据 → agent：解释原因码与证据要求 → human：确认关键事实 → reviewer：审核后放行 → submit_condition：证据满足对应原因码要求 → upstream_result：NOT_STATED → final_status：PENDING
...
- **所需证据**：
  - 授权响应/授权码/金额/清算日期（AUTH_LOG，必填，默认来源：SYSTEM_OF_RECORD）——为何需要：证明授权有效且按时清算；规则依据：SRC-03 §10；SRC-01 P31；本案可得性：视案件而定；缺失后果：建议接受
- **处理流程**：first_see：案件进入后按原因码匹配规则 → auto：规则引擎装载对应条件与证据清单 → ops：按清单收集证据 → agent：解释原因码与证据要求 → human：确认关键事实 → reviewer：审核后放行 → submit_condition：证据满足对应原因码要求 → upstream_result：NOT_STATED → final_status：PENDING
...
- **所需证据**：
  - 订单/授权/清算多字段比对（ORDER_MATCH，必填，默认来源：CONDITIONAL）——为何需要：判定是否重复；规则依据：SRC-03 §9；本案可得性：视案件而定；缺失后果：无法判定
- **处理流程**：first_see：案件进入后按原因码匹配规则 → auto：规则引擎装载对应条件与证据清单 → ops：按清单收集证据 → agent：解释原因码与证据要求 → human：确认关键事实 → reviewer：审核后放行 → submit_condition：证据满足对应原因码要求 → upstream_result：NOT_STATED → final_status：PENDING
...
- **所需证据**：
  - 取消/退款政策披露证明（POLICY，必填，默认来源：MERCHANT_UPLOAD）——为何需要：证明政策已告知；规则依据：SRC-01 P17/P49-50；本案可得性：视案件而定；缺失后果：须退款
  - 取消时间/未按政策取消证明（TIMESTAMP，必填，默认来源：OCR_THEN_REVIEW）——为何需要：证明取消不符合约定；规则依据：SRC-01 P49-50；本案可得性：视案件而定；缺失后果：抗辩无据
- **处理流程**：first_see：案件进入后按原因码匹配规则 → auto：规则引擎装载对应条件与证据清单 → ops：按清单收集证据 → agent：解释原因码与证据要求 → human：确认关键事实 → reviewer：审核后放行 → submit_condition：证据满足对应原因码要求 → upstream_result：NOT_STATED → final_status：PENDING
...
- **所需证据**：
  - 已修/已换/按约交付说明（MERCHANT_NARRATIVE，必填，默认来源：MERCHANT_UPLOAD）——为何需要：2700 抗辩；规则依据：SRC-02 P160-170；本案可得性：视案件而定；缺失后果：转向其他抗辩
  - 专家/检验意见（INSPECTION，可选，默认来源：MERCHANT_UPLOAD）——为何需要：强化质量/真实性证明；规则依据：SRC-02 P158-159；本案可得性：视案件而定；缺失后果：主观争议难反驳
- **处理流程**：first_see：案件进入后按原因码匹配规则 → auto：规则引擎装载对应条件与证据清单 → ops：按清单收集证据 → agent：解释原因码与证据要求 → human：确认关键事实 → reviewer：审核后放行 → submit_condition：证据满足对应原因码要求 → upstream_result：NOT_STATED → final_status：PENDING
...
- **所需证据**：
  - 交付证明（签收/QR/PIN 使用/航班已发生）（DELIVERY，必填，默认来源：CONDITIONAL）——为何需要：证明已提供；规则依据：SRC-02 P183/P972；本案可得性：视案件而定；缺失后果：抗辩无据
- **处理流程**：first_see：案件进入后按原因码匹配规则 → auto：规则引擎装载对应条件与证据清单 → ops：按清单收集证据 → agent：解释原因码与证据要求 → human：确认关键事实 → reviewer：审核后放行 → submit_condition：证据满足对应原因码要求 → upstream_result：NOT_STATED → final_status：PENDING
...
- **所需证据**：
  - 退款记录（REFUND_RECORD，必填，默认来源：SYSTEM_OF_RECORD）——为何需要：证明已退或不该退；规则依据：SRC-02 P273-276；本案可得性：视案件而定；缺失后果：建议退款
- **处理流程**：first_see：案件进入后按原因码匹配规则 → auto：规则引擎装载对应条件与证据清单 → ops：按清单收集证据 → agent：解释原因码与证据要求 → human：确认关键事实 → reviewer：审核后放行 → submit_condition：证据满足对应原因码要求 → upstream_result：NOT_STATED → final_status：PENDING
...
- **所需证据**：
  - 3DS 认证（ECI 211/212/217/242）（AUTH，可选，默认来源：SYSTEM_OF_RECORD）——为何需要：认证抗辩；规则依据：SRC-02 P503；本案可得性：视案件而定；缺失后果：转向 CE
  - Compelling Evidence（注册/历史交易等）（COMP_EVID，可选，默认来源：CONDITIONAL）——为何需要：证明持卡人参与；规则依据：SRC-02 P505-509；本案可得性：视案件而定；缺失后果：无 CE 则建议接受
- **处理流程**：first_see：案件进入后按原因码匹配规则 → auto：规则引擎装载对应条件与证据清单 → ops：按清单收集证据 → agent：解释原因码与证据要求 → human：确认关键事实 → reviewer：审核后放行 → submit_condition：证据满足对应原因码要求 → upstream_result：NOT_STATED → final_status：PENDING
...
- **所需证据**：
  - 授权记录（AUTH_LOG，必填，默认来源：SYSTEM_OF_RECORD）——为何需要：2008/2713 抗辩；规则依据：SRC-02 P64-73/P889-890；本案可得性：视案件而定；缺失后果：建议接受
- **处理流程**：first_see：案件进入后按原因码匹配规则 → auto：规则引擎装载对应条件与证据清单 → ops：按清单收集证据 → agent：解释原因码与证据要求 → human：确认关键事实 → reviewer：审核后放行 → submit_condition：证据满足对应原因码要求 → upstream_result：NOT_STATED → final_status：PENDING
...
- **所需证据**：
  - 终端/交易记录（按子类）（TX_RECORD，必填，默认来源：SYSTEM_OF_RECORD）——为何需要：证明处理正确；规则依据：SRC-02 P685-776；本案可得性：视案件而定；缺失后果：建议接受
- **处理流程**：first_see：案件进入后按原因码匹配规则 → auto：规则引擎装载对应条件与证据清单 → ops：按清单收集证据 → agent：解释原因码与证据要求 → human：确认关键事实 → reviewer：审核后放行 → submit_condition：证据满足对应原因码要求 → upstream_result：NOT_STATED → final_status：PENDING
...
- **所需证据**：
  - DE 55/芯片数据/终端能力（EMV_DATA，必填，默认来源：SYSTEM_OF_RECORD）——为何需要：责任判定；规则依据：SRC-02 P588-589；本案可得性：视案件而定；缺失后果：责任转移
- **处理流程**：first_see：案件进入后按原因码匹配规则 → auto：规则引擎装载对应条件与证据清单 → ops：按清单收集证据 → agent：解释原因码与证据要求 → human：确认关键事实 → reviewer：审核后放行 → submit_condition：证据满足对应原因码要求 → upstream_result：NOT_STATED → final_status：PENDING
...
- **所需证据**：
  - 交付/退款证明（类比）（DELIVERY，必填，默认来源：CONDITIONAL）——为何需要：证明履约或退款；规则依据：SRC-03 §28（映射，非 Amex 原文）；本案可得性：视案件而定；缺失后果：建议接受
- **处理流程**：first_see：案件进入后按原因码匹配规则 → auto：规则引擎装载对应条件与证据清单 → ops：按清单收集证据 → agent：解释原因码与证据要求 → human：确认关键事实 → reviewer：审核后放行 → submit_condition：证据满足对应原因码要求 → upstream_result：NOT_STATED → final_status：PENDING
...
- **所需证据**：
  - 物流轨迹（TRACKING，必填，默认来源：CONDITIONAL）——为何需要：证明运输；规则依据：SRC-01 P40-41；本案可得性：是；缺失后果：证据链断裂
  - 签收证明（POD，必填，默认来源：OCR_THEN_REVIEW）——为何需要：证明交付给本人；规则依据：SRC-03 §5；本案可得性：是；缺失后果：无法抗辩
...
- **所需证据**：
  - 3DS 认证记录（AUTH，必填，默认来源：SYSTEM_OF_RECORD）——为何需要：认证保护；规则依据：SRC-01 P14/P26；本案可得性：否；缺失后果：转向 CE
  - 同设备历史未争议交易（HISTORY，必填，默认来源：SYSTEM_OF_RECORD）——为何需要：CE 核心；规则依据：SRC-01 P26；本案可得性：否；缺失后果：无法抗辩
...
- **所需证据**：
  - 授权记录（AUTH_LOG，必填，默认来源：SYSTEM_OF_RECORD）——为何需要：2008 抗辩前提；规则依据：SRC-02 P64-73；本案可得性：否；缺失后果：建议接受
...
- **所需证据**：
  - 签收证明（POD，必填，默认来源：OCR_THEN_REVIEW）——为何需要：履约证明；规则依据：SRC-03 §5；本案可得性：是；缺失后果：无法抗辩
...
- **所需证据**：
  - 退款记录（REFUND_RECORD，必填，默认来源：SYSTEM_OF_RECORD）——为何需要：本可抗辩；规则依据：SRC-02 P273-276；本案可得性：否；缺失后果：已过期，不再收集
...
- **所需证据**：
  - 签收证明（POD，必填，默认来源：OCR_THEN_REVIEW）——为何需要：收件人比对；规则依据：SRC-03 §5；本案可得性：是（OCR 有误）；缺失后果：比对失败则无法抗辩
...
- **所需证据**：
  - 登录/访问记录（USAGE_LOG，必填，默认来源：CONDITIONAL）——为何需要：证明使用；规则依据：SRC-03 §12；本案可得性：是；缺失后果：无法抗辩
...
- **所需证据**：
  - 按约交付说明（MERCHANT_NARRATIVE，必填，默认来源：MERCHANT_UPLOAD）——为何需要：2700 抗辩；规则依据：SRC-02 P160-170；本案可得性：是；缺失后果：抗辩不成立
...
- **所需证据**：
  - 交付证明（DELIVERY，必填，默认来源：CONDITIONAL）——为何需要：履约；规则依据：SRC-02 P182-184；本案可得性：是；缺失后果：抗辩无据
...
- **所需证据**：
  - 3DS 认证（ECI 5）（AUTH，必填，默认来源：SYSTEM_OF_RECORD）——为何需要：认证保护；规则依据：SRC-01 P14；本案可得性：是；缺失后果：保护缺失
  - 同设备历史交易（HISTORY，可选，默认来源：SYSTEM_OF_RECORD）——为何需要：佐证本人交易；规则依据：SRC-01 P26；本案可得性：是；缺失后果：佐证减弱
  - 签收证明（POD，可选，默认来源：OCR_THEN_REVIEW）——为何需要：佐证收货；规则依据：SRC-01 P54；本案可得性：是；缺失后果：佐证减弱
...
- **所需证据**：
  - 退款 ARN/日期/金额/结算状态（REFUND_TX，必填，默认来源：SYSTEM_OF_RECORD）——为何需要：证明退款；规则依据：SRC-03 §8；本案可得性：是；缺失后果：建议接受
...
- **所需证据**：
  - 订单/授权/清算比对（ORDER_MATCH，必填，默认来源：CONDITIONAL）——为何需要：重复判定；规则依据：SRC-03 §9；本案可得性：是；缺失后果：无法判定
...
- **所需证据**：
  - SKU/商品页快照（PRODUCT_DESC，必填，默认来源：MERCHANT_UPLOAD）——为何需要：一致性证明；规则依据：SRC-03 §7；本案可得性：是；缺失后果：抗辩无据
  - 发货序列号记录（DELIVERY_RECORD，必填，默认来源：OCR_THEN_REVIEW）——为何需要：证明所发商品；规则依据：SRC-03 §7；本案可得性：是；缺失后果：抗辩无据
