...
def test_openapi_has_exact_foundation_paths(app: FastAPI):
    ...
    assert set(paths) == V21_PATHS | {
        ...
        "/api/v2/cases/{case_id}/agent",
        "/api/v2/cases/{case_id}/agent/run",
        "/api/v2/cases/{case_id}/agent/messages",
        "/api/v2/cases/{case_id}/agent/proposals/{proposal_id}/execute",
        "/api/v2/cases/{case_id}/collaboration/samples/{code}",
        "/api/v2/commands",
        "/api/v2/rules",
        "/api/v2/governance",
        "/api/v2/capabilities",
    ...
    assert {path: set(item) for path, item in paths.items()} == V21_METHODS | {
        ...
        "/api/v2/cases/{case_id}/agent": {"get"},
        "/api/v2/cases/{case_id}/agent/run": {"post"},
        "/api/v2/cases/{case_id}/agent/messages": {"post"},
        "/api/v2/cases/{case_id}/agent/proposals/{proposal_id}/execute": {"post"},
        "/api/v2/cases/{case_id}/collaboration/samples/{code}": {"get"},
